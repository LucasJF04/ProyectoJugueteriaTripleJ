...
<div class="wrapper">
  ...
  <div class="col-md-3 col-sm-6 col-12">
  <div class="card">
    <img src="https://http2.mlstatic.com/D_NQ_NP_769411-MLU77491136777_072024-O.webp" class="card-img-top" alt="Producto 1">
    <div class="card-body">
      <h5 class="card-title">Producto 1</h5>
      <p class="card-text">Descripción breve del producto 1.</p>
      <!-- Botón para abrir el modal -->
      <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#transferModal">Añadir al carrito</a>
    </div>
  </div>
</div>
...
<div class="modal fade" id="transferModal" tabindex="-1" role="dialog" aria-labelledby="transferModalLabel" aria-hidden="true">
  ...
  <div class="col-md-3 col-sm-6 col-12">
    <div class="card">
      <img src="https://th.bing.com/th/id/OIP.zDnmQoZTNNw15JUgFIqCaAHaHK?rs=1&pid=ImgDetMain" class="card-img-top" alt="Producto 1">
      <div class="card-body">
        <h5 class="card-title">Producto 1</h5>
        <p class="card-text">Descripción breve del producto 1.</p>
...
<div class="row">
  ...
  <div class="col-md-3 col-sm-6 col-12">
    <div class="card">
      <img src="ruta/a/la/imagen5.jpg" class="card-img-top" alt="Producto 5">
      <div class="card-body">
  ...
  <div class="col-md-3 col-sm-6 col-12">
    <div class="card">
      <img src="ruta/a/la/imagen6.jpg" class="card-img-top" alt="Producto 6">
      <div class="card-body">
  ...
  <div class="col-md-3 col-sm-6 col-12">
    <div class="card">
      <img src="ruta/a/la/imagen7.jpg" class="card-img-top" alt="Producto 7">
      <div class="card-body">
  ...
  <div class="col-md-3 col-sm-6 col-12">
    <div class="card">
      <img src="ruta/a/la/imagen8.jpg" class="card-img-top" alt="Producto 8">
      <div class="card-body">
...
<div class="row">
  ...
  <div class="col-md-3 col-sm-6 col-12">
    <div class="card">
      <img src="ruta/a/la/imagen9.jpg" class="card-img-top" alt="Producto 9">
      <div class="card-body">
  ...
  <div class="col-md-3 col-sm-6 col-12">
    <div class="card">
      <img src="ruta/a/la/imagen10.jpg" class="card-img-top" alt="Producto 10">
      <div class="card-body">
  ...
  <div class="col-md-3 col-sm-6 col-12">
    <div class="card">
      <img src="ruta/a/la/imagen11.jpg" class="card-img-top" alt="Producto 11">
      <div class="card-body">
  ...
  <div class="col-md-3 col-sm-6 col-12">
    <div class="card">
      <img src="ruta/a/la/imagen12.jpg" class="card-img-top" alt="Producto 12">
      <div class="card-body">
